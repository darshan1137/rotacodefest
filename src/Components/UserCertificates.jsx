    ...
    const fetchUserData = async () => {
      ...
      try {
        ...
        if (userSnapshot.exists()) {
          ...
          const campaignTitleMap = titles.reduce((acc, titleObj) => ({ ...acc, ...titleObj }), {});
          ...
          navigate("/certificate", {
            state: {
              ...
              campaignProps: {
                ...
                hostName: hostDetails.Fname + ' ' + hostDetails.Lname || 'HostName',
              },
            },
          });
        } else {
          console.error(`Campaign with ID ${campaignId} not found in the requests database`);
        }
      } else {
        console.error(`User with username ${userName} not found in the users database`);
      }
    } catch (error) {
    ...
    <>
      <div className="mx-10 my-10 px-10">
        {userCertificates.length > 0 && (
          <div className="mt-8">
            <h2 className="text-xl font-bold mb-4">Download Your certificates here</h2>
