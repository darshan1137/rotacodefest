...
export default function UserUpcomingCampaign() {
  ...
  return (
    <>
      <div className=" py-2 mt-2  flex flex-col text-center w-full mb-5">
        ...
        <p className="p-3 mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">
          "Explore upcoming campaigns, each holding the promise of new
          connections, meaningful engagement, and positive change."
        </p>
      </div>
