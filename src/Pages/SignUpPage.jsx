...
<div className="mx-auto bg-white max-w-xl py-10 px-4  rounded-lg md:px-8 shadow-lg shadow-green-400">
  ...
  <form className="mx-auto max-w-lg rounded-lg border ring-green-300">
    ...
    <div>
        <label for="first-name" className="mb-2 inline-block text-sm text-green-600 sm:text-base">User name</label>
        <input name="first-name" className="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-green-300 transition duration-100 focus:ring" />
      </div>
      <div>
      ...
      <button className="block rounded-lg bg-green-800 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-green-300 transition duration-100 hover:bg-green-700 focus-visible:ring active:bg-green-600 md:text-base">Sign up</button>
