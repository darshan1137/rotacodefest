  ...
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    ...
    <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
      ...
      <div className="flex justify-center">
        <button className="inline-flex text-white bg-green-500 border-0 rounded-full py-1 px-6 focus:outline-none hover:bg-green-600 rounded text-lg">Button</button>
...
<div className="h-1 bg-green-500 rounded overflow-hidden  flex justify-center items-center">
     ...
     {/* Assuming max width to be 4xl, adjust as per your layout */}
      <div className="h-1 bg-gray-200 rounded overflow-hidden">
        ...
        <div className="flex flex-wrap -m-4 pl-12">
          <div className="p-4 lg:w-1/2 ">
            <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left bg-white rounded-md shadow-lg shadow-green-400/60">
            <img alt="team" className="flex-shrink-0  w-40 h-40 mx-5 object-cover object-center sm:mb-0 mb-20 rounded-full" src="https://dummyimage.com/200x200" />
              ...
              <div className="flex-grow sm:pl-8">
                ...
                <p className="mb-4">Importance of waste management at home</p>
          ...
          <div className="p-4 lg:w-1/2 ">
            <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left bg-white rounded-md shadow-lg shadow-green-400/60 ">
            <img alt="team" className="flex-shrink-0  w-40 h-40 mx-5 my-5 object-cover object-center sm:mb-0 mb-4 rounded-full" src="https://dummyimage.com/200x200" />
              {/* <img alt="team" className="flex-shrink-0 rounded-lg w-48 h-48 object-cover object-center sm:mb-0 mb-4" src={require('https://dummyimage.com/200x200')} /> */}
              <div className="flex-grow sm:pl-8">
                <h2 className="title-font font-medium text-lg text-gray-900">Hazardous Waste Handling</h2>
                {/* <h3 className="text-gray-500 mb-3">UI Developer</h3> */}
                <p className="mb-4">Focus on hazardous waste management</p>
                <span className="inline-flex">
                  <a href="#" className="text-gray-500">
                    <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                      <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
          ...
          <div className="p-4 lg:w-1/2 ">
            <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left bg-white rounded-md shadow-lg shadow-green-400/60 ">
            <img alt="team" className="flex-shrink-0  w-40 h-40 mx-5 object-cover object-center sm:mb-0 mb-4 rounded-full" src="https://dummyimage.com/200x200" />
              {/* <img alt="team" className="flex-shrink-0 rounded-lg w-48 h-48 object-cover object-center sm:mb-0 mb-4" src={require('https://dummyimage.com/200x200')} /> */}
              <div className="flex-grow sm:pl-8">
                <h2 className="title-font font-medium text-lg text-gray-900">Industrial Waste</h2>
                {/* <h3 className="text-gray-500 mb-3">UI Developer</h3> */}
                <p className="mb-4">Address waste management in industrial settings..</p>
                <span className="inline-flex">
                  <a href="#" className="text-gray-500">
                    <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                      <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
          ...
          <div className="p-4 lg:w-1/2  ">
            ...
            <img alt="team" className="flex-shrink-0 w-40 h-40 mx-5 object-cover object-center sm:mb-0 my-6 rounded-full" src="https://dummyimage.com/200x200" />
              {/* <img alt="team" className="flex-shrink-0 rounded-lg w-48 h-48 object-cover object-center sm:mb-0 mb-4" src={require('https://dummyimage.com/200x200')} /> */}
              <div className="flex-grow sm:pl-8">
